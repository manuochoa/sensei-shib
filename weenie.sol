...
contract WeenieLand is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa1feFF2fAC589a1cEFC5fEbBfcd24E73F5838C23); // Marketing Address
    ...
    string private _name = "Weenie Land";
    string private _symbol = "WeLand";
    ...
    function initContract() external onlyOwner() {       
        ...
        marketingAddress = payable(0xa1feFF2fAC589a1cEFC5fEbBfcd24E73F5838C23);
    }
